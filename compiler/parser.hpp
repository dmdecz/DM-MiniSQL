...
/**
 ** \file /Users/chenzhuo/Desktop/Working/DM/compiler/parser.hpp
...
#ifndef YY_YY_USERS_CHENZHUO_DESKTOP_WORKING_DM_COMPILER_PARSER_HPP_INCLUDED
# define YY_YY_USERS_CHENZHUO_DESKTOP_WORKING_DM_COMPILER_PARSER_HPP_INCLUDED
...
switch (yytype)
    {
      case 57: // select_condition_exp
      case 59: // exp
      case 62: // attribute_exp
      case 65: // constrain_exp
      ...
      case 53: // select_list
      case 54: // table_list
      case 55: // select_condition
      case 56: // select_condition_list
      case 61: // attribute_list
      case 64: // constrain_list
        value.template destroy< ExpressionList * > ();
        break;

      case 43: // statement
      case 44: // insert_statement
      case 47: // drop_table_statement
      case 48: // drop_db_statement
      case 49: // use_statement
      case 50: // create_db_statement
      case 52: // select_statement
      case 58: // delete_statement
      case 60: // create_table_statement
        value.template destroy< Statement * > ();
        break;

      case 3: // NUMBER
      case 63: // variant_type
        value.template destroy< int > ();
        break;

      case 39: // STRING
      case 40: // FILENAME
      case 51: // source_statement
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YYASSERT (tok == 0 || tok == token::TOK_SELECT || tok == token::TOK_FROM || tok == token::TOK_WHERE || tok == token::TOK_QUIT || tok == token::TOK_SOURCE || tok == token::TOK_CREATE || tok == token::TOK_TABLE || tok == token::TOK_USE || tok == token::TOK_DATABASE || tok == token::TOK_DROP || tok == token::TOK_INSERT || tok == token::TOK_INTO || tok == token::TOK_VALUES || tok == token::TOK_DELETE || tok == token::TOK_BLANK || tok == token::TOK_END || tok == token::TOK_ENDL || tok == token::TOK_MINUS || tok == token::TOK_PLUS || tok == token::TOK_STAR || tok == token::TOK_SLASH || tok == token::TOK_LPAREN || tok == token::TOK_RPAREN || tok == token::TOK_COMMA || tok == token::TOK_INT || tok == token::TOK_DOUBLE || tok == token::TOK_CHAR || tok == token::TOK_EQUAL || tok == token::TOK_LESS || tok == token::TOK_LARGE || tok == token::TOK_NOT || tok == token::TOK_AND || tok == token::TOK_OR || tok == token::TOK_PRIMARY_KEY || tok == token::TOK_FOREIGN_KEY);
      }
#else
      ...
      symbol_type (int tok, std::string v, location_type l)
        : super_type(token_type (tok), std::move (v), std::move (l))
      {
        YYASSERT (tok == token::TOK_STRING || tok == token::TOK_FILENAME);
      }
#else
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_SOURCE (location_type l)
      {
        return symbol_type (token::TOK_SOURCE, std::move (l));
      }
#else
      static
      symbol_type
      make_SOURCE (const location_type& l)
      {
        return symbol_type (token::TOK_SOURCE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOK_CREATE, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_CREATE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOK_DATABASE, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_DATABASE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOK_DROP, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_DROP, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOK_INSERT, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_INSERT, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOK_INTO, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_INTO, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOK_VALUES, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_DELETE, std::move (l));
      }
#else
      static
      symbol_type
      ...
      static
      symbol_type
      make_LARGE (location_type l)
      {
        return symbol_type (token::TOK_LARGE, std::move (l));
      }
#else
      static
      symbol_type
      make_LARGE (const location_type& l)
      {
        return symbol_type (token::TOK_LARGE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOK_FILENAME, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
...
#line 2011 "/Users/chenzhuo/Desktop/Working/DM/compiler/parser.hpp"





#endif // !YY_YY_USERS_CHENZHUO_DESKTOP_WORKING_DM_COMPILER_PARSER_HPP_INCLUDED
